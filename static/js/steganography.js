...
class Steganography {
     ...
     * @returns {string} Binary representation of text
     */
    textToBinary(text) {
        let binary = '';
        for (let i = 0; i < text.length; i++) {
            // Get character code and convert to 8-bit binary
    ...
    /**
     * Converts a number to binary representation with specified bit length
     * @param {number} number - Number to convert
     * @param {number} bits - Number of bits in result
     * @returns {string} Binary representation with specified length
     */
    numberToBinary(number, bits) {
